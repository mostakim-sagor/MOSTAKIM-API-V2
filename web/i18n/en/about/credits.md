...
mostakim is made with love and care by [imput](https://imput.net/) ❤️
...
they also helped us ship mostakim 10!
<BetaTesters />
...
a portion of mostakim's processing infrastructure
...
meowbalt is mostakim's speedy mascot, a very expressive cat who loves fast internet.

all amazing art of meowbalt that you see in mostakim
...
mostakim api (processing server) code is open source and licensed under [AGPL-3.0]({docs.apiLicense}).

mostakim frontend code is [source first](https://sourcefirst.com/) and is licensed under [CC-BY-NC-SA 4.0]({docs.webLicense}).
